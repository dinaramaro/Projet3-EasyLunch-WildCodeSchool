...
const Restaurant = () => (
  <Container>
    ...
    <div>
      <h2 className="restaurant-title-h2">OPTIMISEZ VOTRE SERVICE DU MIDI!</h2>
      <p>
      ...
      <ul>
        <li className="li-restaurant">Anticipation et optimisation du service du midi (toutes les commandes doivent être passées avant 11h30) ;</li>
        <li className="li-restaurant">Hausse de la qualité de service (concentration sur le cœur de métier, à savoir cuisiner et servir) ;</li>
        <li className="li-restaurant">Abandon des tâches à faible valeur ajoutée (à savoir la prise de commande et le paiement) ;</li>
        <li className="li-restaurant">Visibilité des plats du jour (les clients Easy Lunch peuvent prendre connaissance des plats du jour de tous les</li>
        <li className="li-restaurant">restaurants partenaires sur une seule et même plateforme) ;</li>
        <li className="li-restaurant">Flexibilité (vous utilisez Easy Lunch comme vous voulez et quand vous voulez).</li>
        <li className="li-restaurant">L’espace restaurateur a été conçu dans l’optique d’être le plus simple possible. En effet, gérer son espace </li>
        <li className="li-restaurant">restaurateur ne prend pas plus de 5  minutes par jour !</li>
      </ul>
    </div>
